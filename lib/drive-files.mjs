// lib/drive-files.mjs — 에이전트 생성 산출물을 Google Drive(StellaGPT/0download)에 저장.
...
const BASE_FOLDER = "0download"; // StellaGPT/0download (root = getDriveRootId() = StellaGPT)
...
export { BASE_FOLDER, ymdKST, cleanSeg };
