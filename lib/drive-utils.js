...
export async function buildDriveContextForChat(message = {}) {
  ...
  let data = null;
  if (target) {
    try { data = await readDriveTarget({ ...target, recursive: false, maxFiles: 12 }); }
    catch (e) { data = null; }
  }
