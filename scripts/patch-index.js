...
function initEvents()`);
  ...
  s=s.replace(/function getSearchConfig\(\)\{[\s\S]*?\}/,`function getSearchConfig(){return{search:'auto',searchProvider:'auto',searchType:'auto'}}`);
}
